...
var AdminText = /** @class */ (function (_super) {
     ...
     */
    AdminText.prototype.onParentPlace = function (parentHtmlElement, htmlElement) {
    ...
    AdminText.prototype.output = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, ("<div>\n\t\t\t<label class=\"form-label\">".concat(this.inner, "</label><input class=\"form-control\" type = \"text\" value = \"\" />\n\t\t</div>"))];
            });
        });
    };
    return AdminText;
...
hotstaq_1.Hot.CurrentPage.processor.addComponent(AdminText);
